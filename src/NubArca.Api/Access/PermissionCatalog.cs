...
public static class PermissionCatalog
{
    ...
    [
        ...
        new(Permissions.PartyAccess, PermissionGroups.Features, false),
        new(Permissions.PartyContributions, PermissionGroups.Features, false,
            Parent: Permissions.PartyAccess),
        new(Permissions.PartyGames, PermissionGroups.Features, false,
            Parent: Permissions.PartyAccess),
        new(Permissions.PartyPrint, PermissionGroups.Features, false,
            Parent: Permissions.PartyAccess),
        new(Permissions.PartyFaceSearch, PermissionGroups.Features, false,
            Parent: Permissions.PartyAccess),
