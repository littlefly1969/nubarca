...
public sealed class SqliteWebApplicationFactory : WebApplicationFactory<Program>
{
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.ConfigureServices((context, services) =>
        {
            ...
            services.AddScoped<ITvPartyPresentationService, TvPartyPresentationService>();
    ...
    services.AddScoped<NubArca.Api.Party.IPartyService, NubArca.Api.Party.PartyService>();
            ...
            services.AddSingleton<NubArca.Api.Party.IPartyGuestIdentity, NubArca.Api.Party.PartyGuestIdentity>();
